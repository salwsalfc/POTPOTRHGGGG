...
قم بلأشتراك، وأرسل /start .
        '''
        return await query.edit_message_text(k, reply_markup=mk([[btn(f'- @wasit_go .', url=f't.me/wasit_go')]]))
        ...
        if tex.text:
            ...
            for i in range(int(count)):
                ...
                if o:
                    ...
                    continue
            for i in range(y):
                user_info['wasit_go'] = int(user_info['wasit_go']) - int(spam_price) 
        ...
        if ask2.text and "t.me" in ask2.text:
            ...
            for i in range(count):
                ...
                if o:
                    ...
                    continue
            for j in range(y):
                user_info['wasit_go'] = int(user_info['wasit_go']) - int(force_price) 
            db.set(f"user_{user_id}", user_info)
        ...
        if ask2.text:
            ...
            for i in range(count):
                ...
                if o:
                    ...
                    continue
            for j in range(y):
                user_info['wasit_go'] = int(user_info['wasit_go']) - int(members_price) 
            db.set(f"user_{user_id}", user_info)
            await ask2.reply(f"اكتملت العملية بنجاح...\nالنتائج:\nارسال ناجح: {y} .\nالطلب: {count} .\n .")
            return
    ...
    if 't.me' in ask2.text:
        ...
        for i in range(count):
            ...
            if o:
                ...
                continue
        for j in range(y):
            user_info['wasit_go'] = int(user_info['wasit_go']) - int(poll_price) 
        db.set(f"user_{user_id}", user_info)
        await ask2.reply(f"اكتملت العملية بنجاح...\nالنتائج:\nارسال ناجح: {y} .\nالطلب: {count} .\n .")
        return
...
قم بلأشتراك، وأرسل /start .
    ...
    if ask.text:
        ...
        if int(x) > int(user_info['wasit_go']):
        ...
        for i in range(count):
            ...
            if o:
                y+=1
        for i in range(y):
            user_info['wasit_go'] = int(user_info['wasit_go']) - int(reaction_price) 
        db.set(f"user_{user_id}", user_info)
    ...
    if ask.text:
        ...
        for i in range(count):
            ...
            if o:
                y+=1
        for i in range(y):
            user_info['wasit_go'] = int(user_info['wasit_go']) - int(view_price) 
        db.set(f"user_{user_id}", user_info)
        await ask1.reply(f"اكتملت العملية بنجاح...\nالنتائج:\nارسال ناجح: {y} .\nالطلب: {count} .\n .")
        return
